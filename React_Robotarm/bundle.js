...
/***/ function(module, exports, __webpack_require__) {
	...
	// render
	_reactDom2.default.render(_react2.default.createElement(_app2.default, null), document.getElementById('content')); // import =====================================================================
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appAction = __webpack_require__(163);

	var _appAction2 = _interopRequireDefault(_appAction);

	var _appStore = __webpack_require__(164);
	...
	var RobotArmApp = function (_React$Component) {
	    _inherits(RobotArmApp, _React$Component);

	    function RobotArmApp(props) {
	        _classCallCheck(this, RobotArmApp);

	        //create instance : dispatcher,action,store
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RobotArmApp).call(this, props));
	        ...
	        _this.create_texture = _this.create_texture.bind(_this);
	        _this.set_attribute = _this.set_attribute.bind(_this);
	        _this.create_ibo = _this.create_ibo.bind(_this);
	        _this.create_program = _this.create_program.bind(_this);
	        _this.create_shader = _this.create_shader.bind(_this);
	        _this.initialize = _this.initialize.bind(_this);
	        _this.create_vbo = _this.create_vbo.bind(_this);
	        return _this;
	    }

	    _createClass(RobotArmApp, [{
	        key: 'styles',
	        ...
	        value: function componentDidMount() {
	            this.refs.canvas;
	            this.c = _reactDom2.default.findDOMNode(this.refs.canvas);
	            this.initWebGL();
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('canvas', { id: 'canvas', width: this.canvasWidth, height: this.canvasHeight, ref: 'canvas' }),
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    '根元関節',
	                    _react2.default.createElement('br', null),
	                    _react2.default.createElement('input', { id: this.state.slider[0].id, type: 'range', onChange: this.sliderChange.bind(this), value: this.state.slider[0].value, min: this.state.slider[0].min, max: this.state.slider[0].max, step: this.state.slider[0].step }),
	                    _react2.default.createElement('br', null),
	                    _react2.default.createElement('input', { id: this.state.slider[1].id, type: 'range', onChange: this.sliderChange.bind(this), value: this.state.slider[1].value, min: this.state.slider[1].min, max: this.state.slider[1].max, step: this.state.slider[1].step }),
	                    _react2.default.createElement('br', null)
	                ),
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	                    ...
	                    '中央関節',
	                    _react2.default.createElement('br', null),
	                    _react2.default.createElement('input', { id: this.state.slider[2].id, type: 'range', onChange: this.sliderChange.bind(this), value: this.state.slider[2].value, min: this.state.slider[2].min, max: this.state.slider[2].max, step: this.state.slider[2].step }),
	                    _react2.default.createElement('br', null),
	                    _react2.default.createElement('input', { id: this.state.slider[3].id, type: 'range', onChange: this.sliderChange.bind(this), value: this.state.slider[3].value, min: this.state.slider[3].min, max: this.state.slider[3].max, step: this.state.slider[3].step }),
	                    _react2.default.createElement('br', null)
	                ),
	                _react2.default.createElement(
	                    'p',
	        ...
	        value: function initialize() {
	            ...
	            this.socket.on("push3", function (push_data) {
	                //サーバーから受信
	         ...
	         */
	        value: function create_shader(source, type) {
	            // シェーダを格納する変数
	            var shader;
	        ...
	        key: 'create_ibo',
	        value: function create_ibo(data) {
	            // バッファオブジェクトの生成
	        ...
	        key: 'set_attribute',
	        value: function set_attribute(vbo, attL, attS) {
	            // 引数として受け取った配列を処理する
	            for (var i in vbo) {
	                // バッファをバインドする
	        ...
	        key: 'create_texture',
	        value: function create_texture(source, number, callback) {
	            // イメージオブジェクトの生成
	            var img = new Image();
...
/***/ function(module, exports) {
	...
	var Action = function () {
	    ...
	    _createClass(Action, [{
	        key: "updateSlider",
	        value: function updateSlider(id, value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = function (_EventEmitter) {
	    ...
	    function Store(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Store).call(this, props));

	        _this.slider = [];
	        _this.slider.push(new SliderStrict({
	            id: "slider0",
	            min: "-2.7",
	            max: "2.7",
	            step: "0.01",
	        ...
	        _this.dispatcher.register(function (payload) {
	            if (payload.actionType === "update_slider") {
	                ...
	                for (var i = 0; i < _this.slider.length; i++) {
	                    if (_this.slider[i].id === payload.id) {
	                        _this.slider[i].value = payload.value;
	                    }
	                }
	...
	var CanvasStruct = function CanvasStruct(props) {
	    _classCallCheck(this, CanvasStruct);
